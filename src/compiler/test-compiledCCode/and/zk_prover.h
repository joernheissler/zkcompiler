...
#define zk_argSize_vCommitment 3
#define zk_argSize_vPublicCommitment_x0 1
#define zk_argSize_vPublicCommitment_x1 1
#define zk_argSize_vPublicCommitment_x2 1
#define zk_argSize_vResponse 6
#define zk_argSize_vSecret_w0 2
#define zk_argSize_vSecret_w1 2
#define zk_argSize_vSecret_w2 2
