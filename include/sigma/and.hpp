#ifndef ZK_SIGMA_AND_HPP
#define ZK_SIGMA_AND_HPP
...
namespace ZKCompiler {
    namespace sigma {
        ...
        /*! \brief AND composition of Sigma protocols */
        class And : public Sigma {
            public:
                /*! \brief Constructor classic mode */
                And(Sigma **proofs, unsigned int n);
                 ...
                 */
                And(Parser *p, unsigned int n, char *const params[]);
                ...
                void setChallenge(const CMV::bnz_t& c);
